# 07: Procedural Web Audio Synthesis & Live Barrier Dissolve Particle Shockwave

**What to build:** Crossing the 70% Stack threshold (via challenge answers or 1-click jump) triggers Web Audio API procedural synthesis (harmonic chimes, ascending unlock arpeggio) and a dramatic 3D Barrier Dissolve: the camera frames the Recursion Lab as the crimson laser barrier violently flickers and explodes into an expanding cloud of cyan energy particles, opening the advanced Wing for Avatar entry.
