# 03: Central Dais AI Mentor Beacon & Contextual Feynman Guidance

**What to build:** An in-world holographic AI Mentor beacon hovers on the Central Dais. Approaching within range prompts `[E] Consult AI Mentor`. Pressing `[E]` opens a glassmorphic dialogue overlay where the AI Mentor analyzes the learner's active prerequisite gaps and delivers contextual Feynman-style conceptual explanations (e.g., explaining why Stacks are required before Recursion because computer memory tracks nested function execution on a call stack).
