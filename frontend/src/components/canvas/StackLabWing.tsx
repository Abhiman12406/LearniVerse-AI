...
export const StackLabWing: React.FC = () => {
  ...
  // Face archway entrance (toward atrium center)
  const chamberRotationY = (-150 * Math.PI) / 180 + Math.PI;
